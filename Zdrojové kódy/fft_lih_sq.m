...
name3 = {'0_500k_1v_sq.csv','0_500k_5v_sq.csv','0_500k_10v_sq.csv','0_500k_15v_sq.csv','0_500k_20v_sq.csv'};
name2 = {'0_30k_1v_sq.csv','0_30k_5v_sq.csv','0_30k_10v_sq.csv','0_30k_15v_sq.csv','0_30k_20v_sq.csv'};
name1 = {'0_100_1v_sq.csv','0_100_5v_sq.csv','0_100_10v_sq.csv','0_100_15v_sq.csv','0_100_20v_sq.csv'};
name = name3;

A = {'1V','5V', '10V','15V','20V'};

% Výstupní složka pro uložení grafů
outputFolder = '500kHzsq';
...
ylabel('Amplituda [V]');
xlabel('Frekvence [Hz]');
xticks([0,500e3:1e6:10e6]);
grid on;
subplot(2,1,2)
plot(fy,P1);
title(['Spektrum obdélníkového signálu ethanolu s amplitudou',A(n)]);
%xlim([0 fmax]);
xticks([0,500e3:1e6:10e6]);
ylabel('Amplituda [V]');
xlabel('Frekvence [Hz]');
...
% Uložení grafu
outputFileName = fullfile(outputFolder, ['500kHzsq_' A{n} '.jpg']);
...
% hold on;
% plot(time, u2)
% title(['obdélníkového signálu s amplitudou',A(n),]);
% xlabel('Frekvence (Hz)');
% ylabel('P1(f)');
